...
def main(img: np.ndarray) -> str:
    ...
    :return: 'Желтый/белый', 'Коричневый', 'Красный или пурпурный', 'Оранжевый', 'Телесный', 'Черный'
    """
    info = ["Желтый/белый", "Коричневый", "Красный или пурпурный", "Оранжевый", "Телесный", "Черный"]
    X_temp = [img]
