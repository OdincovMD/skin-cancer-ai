...
def main(img, mask) -> str:
    ...
    :param mask: маска изображения
    :return: предсказанная метка 'Сочетания коричневого, синего, серого, черного', 'Преимущественно красный или черный', 'Преимущественно желтый или оранжевый'
    """
    ...
    if pred[0] == 1:
        return 'Сочетания коричневого, синего, серого, черного'
    elif pred[0] == 0:
        return 'Преимущественно красный или черный'
    else:
        return 'Преимущественно желтый или оранжевый'
